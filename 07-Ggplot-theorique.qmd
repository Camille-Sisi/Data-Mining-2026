...
Il y a plusieurs thèmes existants dans le package **`ggplot2`**, `theme_gray()` est le thème par défaut ; les autres sont présentés dans la figure ci-dessous. ![](Images/Liste_Themes_Ggplot.png)
